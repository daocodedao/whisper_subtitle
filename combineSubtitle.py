...
# 
    ffcommand=f"ffmpeg -y -i {outPutMp4} -vf subtitles=\"{subtitleDstPath}:force_style='FontName=ubuntu,Alignment=2,Outline=1,Shadow=0,FontSize=10'\" {outPutSubtitleMp4}"
