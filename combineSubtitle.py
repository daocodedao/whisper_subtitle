...
def combinSubtitle(outPutMp4, subtitleDstPath, outPutSubtitleMp4):
    ...
    ffcommand=f"ffmpeg -y -i {outPutMp4} -vf subtitles=\"{subtitleDstPath}:force_style='FontName=simsun,Alignment=2,BorderStyle=3,Outline=1,Shadow=0,FontSize=9'\" {outPutSubtitleMp4}"
